...
final class BackupPolicyResource extends Resource
{
    ...
    {
        return $table->columns([TextColumn::make('name')->searchable(), TextColumn::make('storage_driver'), TextColumn::make('retention_days'), TextColumn::make('encrypted')->badge(), TextColumn::make('active')->badge()]);
    }
