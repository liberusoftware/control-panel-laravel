...
final class OsAdapterController
{
    ...
    public function package(Request $request, RecordOsResource $record): JsonResponse { return $this->record($request, $record, OsPackage::class, ['name' => ['required', 'string', 'max:160'], 'version' => ['nullable', 'string', 'max:80'], 'architecture' => ['nullable', 'string', 'max:40'], 'status' => ['required', 'string', 'max:40'], 'metadata' => ['nullable', 'array']]); }
    public function service(Request $request, RecordOsResource $record): JsonResponse { return $this->record($request, $record, OsService::class, ['name' => ['required', 'string', 'max:160'], 'version' => ['nullable', 'string', 'max:80'], 'status' => ['required', 'string', 'max:40'], 'enabled' => ['sometimes', 'boolean'], 'metadata' => ['nullable', 'array']]); }
    public function firewall(Request $request, RecordOsResource $record): JsonResponse { return $this->record($request, $record, FirewallRule::class, ['direction' => ['required', 'in:inbound,outbound'], 'action' => ['required', 'in:allow,deny,reject'], 'protocol' => ['nullable', 'string', 'max:20'], 'port' => ['nullable', 'integer', 'between:1,65535'], 'source' => ['nullable', 'string', 'max:64'], 'comment' => ['nullable', 'string', 'max:255']]); }
    public function user(Request $request, RecordOsResource $record): JsonResponse { return $this->record($request, $record, OsUser::class, ['username' => ['required', 'string', 'max:80'], 'uid' => ['nullable', 'integer', 'min:0'], 'shell' => ['nullable', 'string', 'max:255'], 'home' => ['nullable', 'string', 'max:1024'], 'sudo' => ['sometimes', 'boolean'], 'status' => ['required', 'string', 'max:40'], 'metadata' => ['nullable', 'array']]); }
    public function filesystem(Request $request, RecordOsResource $record): JsonResponse { return $this->record($request, $record, FilesystemMount::class, ['device' => ['required', 'string', 'max:255'], 'mount_path' => ['required', 'string', 'max:1024'], 'filesystem' => ['nullable', 'string', 'max:80'], 'size_bytes' => ['nullable', 'integer', 'min:0'], 'free_bytes' => ['nullable', 'integer', 'min:0'], 'options' => ['nullable', 'array'], 'mounted' => ['sometimes', 'boolean']]); }
    public function repository(Request $request, RecordOsResource $record): JsonResponse { return $this->record($request, $record, PackageRepository::class, ['name' => ['required', 'string', 'max:160'], 'url' => ['required', 'url', 'max:2048'], 'distribution' => ['nullable', 'string', 'max:80'], 'enabled' => ['sometimes', 'boolean'], 'trusted' => ['sometimes', 'boolean'], 'metadata' => ['nullable', 'array']]); }
