...
final class SecurityFindingController
{
    ...
    public function hardening(Request $request, RecordSecurityResource $record): JsonResponse { return $this->record($request, $record, HardeningControl::class, ['subject_type' => ['required', 'string', 'max:120'], 'subject_id' => ['required', 'string', 'max:160'], 'control' => ['required', 'string', 'max:160'], 'desired' => ['required', 'boolean'], 'observed' => ['required', 'boolean'], 'status' => ['required', 'string', 'max:40'], 'evidence' => ['nullable', 'array']]); }
    public function patch(Request $request, RecordSecurityResource $record): JsonResponse { return $this->record($request, $record, PatchRecord::class, ['subject_type' => ['required', 'string', 'max:120'], 'subject_id' => ['required', 'string', 'max:160'], 'package' => ['required', 'string', 'max:255'], 'target_version' => ['required', 'string', 'max:80'], 'current_version' => ['nullable', 'string', 'max:80'], 'severity' => ['required', 'in:critical,high,medium,low,info'], 'status' => ['required', 'string', 'max:40']]); }
    public function policy(Request $request, RecordSecurityResource $record): JsonResponse { return $this->record($request, $record, MfaRbacPolicy::class, ['subject_type' => ['required', 'string', 'max:120'], 'subject_id' => ['required', 'string', 'max:160'], 'mfa_required' => ['required', 'boolean'], 'roles' => ['nullable', 'array'], 'permissions' => ['nullable', 'array'], 'status' => ['required', 'string', 'max:40']]); }
    ...
    public function malware(Request $request, RecordSecurityResource $record): JsonResponse { return $this->record($request, $record, MalwareScan::class, ['subject_type' => ['required', 'string', 'max:120'], 'subject_id' => ['required', 'string', 'max:160'], 'status' => ['required', 'string', 'max:40'], 'scanner' => ['required', 'string', 'max:120'], 'findings' => ['nullable', 'array']]); }
    public function intrusion(Request $request, RecordSecurityResource $record): JsonResponse { return $this->record($request, $record, IntrusionControl::class, ['subject_type' => ['required', 'string', 'max:120'], 'subject_id' => ['required', 'string', 'max:160'], 'kind' => ['required', 'string', 'max:120'], 'action' => ['required', 'string', 'max:80'], 'threshold' => ['required', 'integer', 'min:1'], 'window_seconds' => ['required', 'integer', 'min:1'], 'enabled' => ['sometimes', 'boolean']]); }
    public function compliance(Request $request, RecordSecurityResource $record): JsonResponse { return $this->record($request, $record, ComplianceStatus::class, ['framework' => ['required', 'string', 'max:120'], 'control' => ['required', 'string', 'max:120'], 'status' => ['required', 'string', 'max:40'], 'score' => ['nullable', 'integer', 'between:0,100'], 'evidence' => ['nullable', 'array']]); }
