...
use Liberu\ControlPanel\WebHostingFilament\Resources\HostedApplicationResource\Pages\ListHostedApplications;

final class HostedApplicationResource extends Resource
{
    protected static ?string $model = HostedApplication::class;
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            ...
            TextInput::make('document_root')->required()->maxLength(2048),
    ...
    {
        return ['index' => ListHostedApplications::route('/'), 'create' => CreateHostedApplication::route('/create'), 'edit' => EditHostedApplication::route('/{record}/edit')];
    }
}
