...
final class FileController
{
    ...
    public function operation(Request $request, RecordFileOperation $record): JsonResponse
    {
        ...
        $data=$request->validate(['file_id'=>['nullable','uuid'],'operation'=>['required','in:copy,move,delete,scan,restore'],'status'=>['nullable','in:queued,running,completed,failed'],'details'=>['nullable','array']]); $item=$record->execute(array_merge($data,['team_id'=>$teamId]));
