...
final class RegisterWorkload
{
    ...
    {
        return Workload::query()->updateOrCreate(['team_id' => $attributes['team_id'] ?? null, 'node_id' => $attributes['node_id'] ?? null, 'name' => $attributes['name']], array_merge(['status' => 'defined', 'specification' => []], $attributes));
    }
}
