...
use Liberu\ControlPanel\SecurityFilament\Resources\PatchRecordResource\Pages\ListPatchRecords;

final class PatchRecordResource extends Resource
{
    protected static ?string $model = PatchRecord::class;
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
            TextColumn::make('package')->searchable()->sortable(),
            TextColumn::make('current_version'),
            TextColumn::make('target_version'),
    ...
    {
        return ['index' => ListPatchRecords::route('/')];
    }
}
