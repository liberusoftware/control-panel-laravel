...
beforeEach(function (): void { foreach ([FilesServiceProvider::class, CertificatesServiceProvider::class, DnsServiceProvider::class, MailServiceProvider::class, MonitoringServiceProvider::class, ContainersServiceProvider::class, KubernetesServiceProvider::class] as $provider) app()->register($provider); $this->artisan('migrate'); });
